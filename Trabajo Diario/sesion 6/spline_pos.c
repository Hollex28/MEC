...
const string  sFileName = "pos_spli.txt";
...
task main()
{
	...
	float Pini=0.0; 	  // valor inicial de la referencia de posición (en radianes)
	...
	float a=Pini;
	float b=Dini;
	float c=3*Pos_final-Pini)-2*Dini+Dfinal;
	float d=2*(Pini-Pos_final)+Dini+Dfinal;
